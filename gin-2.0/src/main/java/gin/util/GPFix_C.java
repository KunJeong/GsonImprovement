...
public class GPFix_C extends GPSimple_Circular {
    
    public static void main(String[] args) {
        GPFix_C sampler = new GPFix_C(args);
        sampler.sampleMethods();
    }   

    public GPFix_C(String[] args) {
        super(args);
    }   

    // Constructor used for testing
    public GPFix_C(File projectDir, File methodFile) {
